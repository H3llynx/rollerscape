        ...
        <main className="flex flex-col w-full m-auto items-center pb-5">
            ...
            <Dialog ref={dialogRef} style="error" close={handleClose}>
                ...
                <div className="flex gap-[5px] text-end flex-row-reverse">
                    <Button style="secondary" className="border-white text-white bg-rgba-dark" onClick={handleClose}>Try again</Button>
                    <Button style="tertiary" className="text-white" onClick={() => handlePasswordReset(email)}>Reset password</Button>
                </div>
            </Dialog>
        </main>
    )
